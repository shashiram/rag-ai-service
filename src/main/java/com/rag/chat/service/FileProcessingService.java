...
import static com.rag.chat.constant.Constants.SUPPORTED_EXTENSIONS;
import static com.rag.chat.constant.Constants.SUPPORTED_TEXT_TYPES;
...
public class FileProcessingService {
    ...
    public void processTextContent(String content) {
        ...
        try {
            ...
            throw ExceptionUtils.vectorStoreViolationException();
        }
    ...
    public String extractContent(MultipartFile file) throws IOException {
        ...
        if (!isSupportedFileType(filename, contentType)) {
            ...
            throw ExceptionUtils.unsupportedFileTypeException(filename);
        }
